...
describe('BookmarkDedupe', function () {
	...
	it('deduplicates correctly', function () {
		delete expectedParse["Bookmarks"].contents['Bookmarks Bar'].contents.a.contents.b.contents['bahamas10/node-netscape-bookmarks'];
		delete expectedParse["Bookmarks"].contents['Bookmarks Bar'].contents.a.contents['bahamas10/node-netscape-bookmarks (1)'];
		delete expectedParse["Bookmarks"].contents['cheeriojs/cheerio'];
		delete expectedParse["Bookmarks"].contents['cheeriojs/cheerio (1)'];
